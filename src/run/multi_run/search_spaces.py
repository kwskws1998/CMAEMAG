...
dl_search_space_by_model_name: dict[DLModelNames, dict] = {
    ...
    DLModelNames.CMAE_MAG_EYE_MODEL: {
        'model': {
            'parameters': {
                'mag_dropout': {'values': dropout},
                'mag_injection_index': {
                ...
                'cmae_mask_ratio': {'values': [0.15, 0.25, 0.4]},
                'cmae_loss_weight': {'values': [0.05, 0.1, 0.2]},
                'cmae_residual_scale': {'values': [0.25, 0.5]},
                'cmae_hidden_dim': {'values': [128, 256]},
                'cmae_dropout': {'values': dropout},
            }
        },
        'trainer': {
            'parameters': {
